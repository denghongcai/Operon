...
sensitivity. For live mount setup, doctor distinguishes missing Linux FUSE
helpers, missing macOS FUSE-T, and missing Windows WinFsp before users hit a
lower-level mount error.
Windows

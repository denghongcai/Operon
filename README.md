...
```bash
scripts/verify-release-install-usability.sh --dry-run v0.16.8 denghongcai/Operon
scripts/verify-release-service-management-smoke.sh --dry-run v0.16.8 denghongcai/Operon
scripts/verify-release-linux-install-containers.sh --dry-run v0.16.8 denghongcai/Operon
```

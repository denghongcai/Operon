...
require_pattern 'argv: value.argv' crates/operon-protocol/src/conversions.rs
...
require_pattern 'exec_run_request_preserves_argv_execution_fields' crates/operon-protocol/src/conversions.rs

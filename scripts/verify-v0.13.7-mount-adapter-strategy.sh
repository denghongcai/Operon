...
require_pattern 'Linux FUSE remains the only supported live mount before v1.0' docs/architecture/technology-and-protocol-decisions.md
require_pattern 'macFUSE FSKit' README.md

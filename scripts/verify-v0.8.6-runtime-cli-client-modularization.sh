...
reject_pattern '^async fn job_' crates/operon-cli/src/main.rs
...
for module in audit auth fs_service job_runtime pagination service_forward state; do
  require_file "crates/operond/src/${module}.rs"
  require_pattern "^mod ${module};" crates/operond/src/main.rs
done
require_pattern 'pub\(crate\) fn start_job' crates/operond/src/job_runtime.rs
require_pattern 'pub\(crate\) fn append_job_log' crates/operond/src/job_runtime.rs
require_pattern 'pub\(crate\) fn finish_job' crates/operond/src/job_runtime.rs
...
reject_pattern '^pub\(crate\) fn append_job_log' crates/operond/src/main.rs
reject_pattern '^pub\(crate\) fn finish_job' crates/operond/src/main.rs
...
require_pattern 'runJob\(' packages/sdk-js/src/index.ts
require_pattern 'getJob\(' packages/sdk-js/src/index.ts
require_pattern 'cancelJob\(' packages/sdk-js/src/index.ts
